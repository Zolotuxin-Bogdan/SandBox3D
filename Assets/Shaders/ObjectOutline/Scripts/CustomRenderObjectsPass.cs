...
{
    public class CustomRenderObjectPass : ScriptableRenderPass
    {
        ...
        public CustomRenderObjectPass(RenderTargetHandle destination, int layerMask, Material overrideMaterial)
        {
